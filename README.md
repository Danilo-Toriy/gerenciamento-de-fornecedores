...
> Implemente uma aplicação Spring Boot para gerenciar fornecedores. O objetivo é
praticar mapeamento JPA com campos específicos de negócio e operações CRUD.
...
| `contato`      | String | Contato do Fornecedor                                |

### <a name="requisitos"></a> ✅ Requisitos
- Crie uma entidade JPA chamada Fornecedor com os atributos especificados
- Configure o nome da entidade JPA como Fornecedor
- Configure o nome da tabela no banco como tb_fornecedor
